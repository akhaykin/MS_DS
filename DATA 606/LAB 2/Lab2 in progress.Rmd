...
1.  Look carefully at these three histograms. How do they compare? Level of detail, histogram 2 is most detailed.Are features revealed in one that are obscured in another? Histogram 2 by having a smaller binwidth is able to record more precisely flights that left early.
...
2.  Create a new data frame that includes flights headed to SFO in February, 
    ...
    meet these criteria? 16 flights meet criteria
...
3.  Describe the distribution of the **arrival** delays of these flights using a 
    ...
    statistics you use should depend on the shape of the distribution.Normal distribution, with very slightly long right tail.
