---
title: 'Lab5B Foundations for statistical inference - Confidence intervals'
author: "Alex Khaykin"
output:
...
1.  What percent of the adults in your sample think climate change affects their 
    local community? 68.3% think climate change does affect their local community.  **Hint:** Just like we did with the population, we can calculate 
    the proportion of those **in this sample** who think climate change affects their 
    local community.

2.  Would you expect another student's sample proportion to be identical to yours? I owuld not expect it to be the same.
    Would you expect it to be similar? It should be similar.  Why or why not? Because the sample size would be the same, and therefore the distribution would too.
...
3.  In the interpretation above, we used the phrase "95% confident". What does "95% confidence" mean? The confidence interval is the upper and lower bounds of the space where we expect our mean to be.
...
4.  Does your confidence interval capture the true population proportion of US adults 
    who think climate change affects their local community? Yes, because 62% falls between 56.6% and 80%. If you are working on this 
    lab in a classroom, does your neighbor's interval capture this value? I am not in class.
...
5.  Each student should have gotten a slightly different confidence interval. What 
    ...
    mean? Yes, most of the time I would expect most or all of the time.  Why? Because were taking a high number of bootstraps, and the mean should always be around it.
...
6.  Given a sample size of 60, 1000 bootstrap samples for each interval, and 50 
    ...
    proportion of your confidence intervals include the true population proportion? 92% are included in the population proportion.
    Is this proportion exactly equal to the confidence level? No it is not. If not, explain why. 
    Make sure to include your plot in your answer.
    
![alt text here](./LAB5 Shiny app.png)    
